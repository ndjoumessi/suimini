...
function biographyPrompt(p: Person, tree: FamilyTree): string {
  return [
    ...
    "Ne commence PAS par un titre Markdown (#). Commence directement par le récit narratif. Tu peux utiliser **gras** pour les noms et dates clés.",
    '',
...
function comparePrompt(a: Person, b: Person, tree: FamilyTree): string {
  return [
    ...
    "Ne commence PAS par un titre Markdown (#). Commence directement par le récit. Tu peux utiliser **gras** pour les noms et dates clés.",
    '',
    'Termine EXACTEMENT par cette section :',
    '### Questions pour approfondir',
    '- (question 1)',
