 ...
 * Mirrors supabase/email-templates/approved.html; kept here so the API route can
 * send it without filesystem access. If you edit one, edit the other.
 */
      ...
      <tr>
        <td align="center" style="padding:32px 16px;">
          <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px; width:100%; background-color:#faf9f6; border:2px solid #1b1b1b; border-radius:0;">
            <tr>
              <td style="background-color:#1b1b1b; padding:24px; font-family:'Space Grotesk', Arial, sans-serif; color:#ffffff; text-transform:uppercase; letter-spacing:2px; font-weight:700; font-size:22px;">SUIMINI</td>
            </tr>
            <tr>
              <td style="padding:32px 28px; color:#1b1b1b; font-family:'Hanken Grotesk', Arial, sans-serif; font-size:15px; line-height:1.6;">
                <h1 style="margin:0 0 16px; font-family:'Space Grotesk', Arial, sans-serif; font-weight:700; font-size:26px; color:#1b1b1b;">Compte activé !</h1>
                ${greeting}
                ...
                <p style="margin:0 0 24px;">
                  <a href="https://suimini.vercel.app" style="background-color:#bf4b2c; color:#ffffff; border:2px solid #1b1b1b; box-shadow:4px 4px 0 #1b1b1b; border-radius:0; padding:14px 28px; font-family:'Space Grotesk', Arial, sans-serif; font-weight:700; font-size:15px; text-decoration:none; display:inline-block;">Accéder à Suimini</a>
                </p>
