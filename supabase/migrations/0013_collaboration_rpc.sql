-- 0013 — porté depuis supabase/collaboration-rpc.sql (framework de migrations versionnées).
...
-- (le runner enveloppe). Source d'origine conservée sous supabase/collaboration-rpc.sql.
-- ============================================================================
