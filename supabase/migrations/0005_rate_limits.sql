-- 0005 — porté depuis supabase/rate-limits.sql (framework de migrations versionnées).
...
-- (le runner enveloppe). Source d'origine conservée sous supabase/rate-limits.sql.
-- ============================================================================
