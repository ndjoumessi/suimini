-- 0016 — porté depuis supabase/birthday-cron.sql (framework de migrations versionnées).
...
-- (le runner enveloppe). Source d'origine conservée sous supabase/birthday-cron.sql.
-- ============================================================================
