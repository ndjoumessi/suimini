-- 0009 — porté depuis supabase/share-public.sql (framework de migrations versionnées).
...
-- (le runner enveloppe). Source d'origine conservée sous supabase/share-public.sql.
-- ============================================================================
