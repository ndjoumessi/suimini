-- 0004 — porté depuis supabase/soft-delete.sql (framework de migrations versionnées).
...
-- (le runner enveloppe). Source d'origine conservée sous supabase/soft-delete.sql.
-- ============================================================================
